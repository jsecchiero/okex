okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/jsecchiero/okex.svg)](https://pkg.go.dev/github.com/jsecchiero/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/jsecchiero/okex.svg)](https://github.com/jsecchiero/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/jsecchiero/okex)](https://goreportcard.com/report/github.com/jsecchiero/okex)
[![GitHub license](https://img.shields.io/github/license/jsecchiero/okex.svg)](https://github.com/jsecchiero/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/jsecchiero/okex.svg)](https://GitHub.com/jsecchiero/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/jsecchiero/okex/actions/workflows/main.yml/badge.svg)](https://github.com/jsecchiero/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/jsecchiero/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/jsecchiero/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/jsecchiero/okex/actions/workflows/release.yml/badge.svg)](https://github.com/jsecchiero/okex/actions/workflows/release.yml)
...
```bash
go get github.com/jsecchiero/okex@v1.1.4-alpha
```
...
import (
  ...
  "github.com/jsecchiero/okex/api"
  "github.com/jsecchiero/okex/events"
  "github.com/jsecchiero/okex/events/public"
  ws_public_requests "github.com/jsecchiero/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/jsecchiero/okex/wiki/Handling-WS-events) 
